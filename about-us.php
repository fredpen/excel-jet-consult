        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="images/sample1.jpg" alt="Excel Jet Consult - abiola david abiola">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="images/sample1.jpg" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="images/sample2.jpg" alt="Excel Jet Consult - abiola david abiola">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="images/sample2.jpg" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="images/sample3.jpg" alt="Excel Jet Consult - abiola david abiola">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="images/sample3.jpg" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="images/sample4.jpg" alt="Excel Jet Consult - abiola david abiola">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="images/sample4.jpg" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        ...
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="images/sample5.jpg" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                   ...
                   <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                    <div class="recent-work-wrap">
                        <img class="img-responsive" src="images/sample6.jpg" alt="Excel Jet Consult
                        ">
                        <div class="overlay">
                            <div class="recent-work-inner">
                                <a class="preview" href="images/sample6.jpg" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="team-area">
        <div class="container">
            <div class="center fadeInDown">
                ...
                <p class="lead">The brain behind Excel Jet Consult - over 5 years experience in training professionals in Microsoft Excel and Power Bi</p>
            </div>
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 single-team">
                    <div class="inner">
                        <div class="team-img">
                            <img src="images/ceo.jpeg" alt="Excel Jet Consult - abiola david abiola">
                        </div>
                        <div class="team-content">
                            <h4>Abiola A. David</h4>
                            <span class="desg">CEO/Founder</span>
                            <div class="team-social">
                                <a class="fa fa-facebook" href="https://www.facebook.com/Googleski"></a>
                                <a class="fa fa-twitter" href="https://twitter.com/AbiolaDavid01"></a>
                                <a class="fa fa-linkedin" href="https://www.linkedin.com/in/courses1/"></a>
                            </div>
                        </div>
                    </div>
                </div>
